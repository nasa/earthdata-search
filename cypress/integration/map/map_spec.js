...
describe('Map interactions', () => {
  ...
  describe('When uploading a shapefile', () => {
    ...
    describe('When the shapefile has a polygon with too many points', () => {
      before(() => {
        const aliases = interceptUnauthenticatedCollections(
          ...
          [{
            ...
            params: 'has_granules_or_cwic=true&include_facets=v2&include_granule_counts=true&include_has_granules=true&include_tags=edsc.extra.%2A%2Copensearch.granule.osdd&options%5Bscience_keywords_h%5D%5Bor%5D=true&options%5Bspatial%5D%5Bor%5D=true&options%5Btemporal%5D%5Blimit_to_granules%5D=true&page_num=1&page_size=20&polygon%5B%5D=-114.14741%2C36.10782%2C-114.0067%2C36.95208%2C-114.0067%2C42.01767%2C-120.05726%2C42.01767%2C-119.91655%2C38.92203%2C-114.56954%2C35.12284%2C-114.71025%2C35.8264%2C-114.14741%2C36.10782&sort_key%5B%5D=has_granules_or_cwic&sort_key%5B%5D=-usage_score'
          }]
        )
      ...
      it('updates the URL', () => {
        cy.url().should('include', '?polygon[0]=-114.14741%2C36.10782%2C-114.0067%2C36.95208%2C-114.0067%2C42.01767%2C-120.05726%2C42.01767%2C-119.91655%2C38.92203%2C-114.56954%2C35.12284%2C-114.71025%2C35.8264%2C-114.14741%2C36.10782&sf=1&sfs[0]=0&m=38.50048828125!-117.02636718749999!6!1!0!0%2C2')
      })
      ...
      it('draws a polygon on the map', () => {
        ...
        cy.get('.leaflet-interactive').last().should('have.attr', 'd', 'M1028 706L1044 610L1044 33L785 29L527 30L355 33L371 386L529 491L683 598L833 707L980 818L964 738L1028 706z')
      })
      ...
      before(() => {
        ...
        const aliases = interceptUnauthenticatedCollections(
          ...
          [{
            ...
            params: 'has_granules_or_cwic=true&include_facets=v2&include_granule_counts=true&include_has_granules=true&include_tags=edsc.extra.%2A%2Copensearch.granule.osdd&keyword=C1214470488-ASF%2A&options%5Bscience_keywords_h%5D%5Bor%5D=true&options%5Bspatial%5D%5Bor%5D=true&options%5Btemporal%5D%5Blimit_to_granules%5D=true&page_num=1&page_size=20&sort_key%5B%5D=has_granules_or_cwic&sort_key%5B%5D=-usage_score'
          },
          {
      ...
      before(() => {
        ...
        const aliases = interceptUnauthenticatedCollections(
          ...
          [{
            ...
            params: 'has_granules_or_cwic=true&include_facets=v2&include_granule_counts=true&include_has_granules=true&include_tags=edsc.extra.%2A%2Copensearch.granule.osdd&keyword=C1972468359-SCIOPS%2A&options%5Bscience_keywords_h%5D%5Bor%5D=true&options%5Bspatial%5D%5Bor%5D=true&options%5Btemporal%5D%5Blimit_to_granules%5D=true&page_num=1&page_size=20&sort_key%5B%5D=has_granules_or_cwic&sort_key%5B%5D=-usage_score'
          },
          {

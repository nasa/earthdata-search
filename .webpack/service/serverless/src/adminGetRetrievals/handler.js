...
/***/ "./serverless/src/adminGetRetrievals/handler.js":
/*!******************************************************!*\
  !*** ./serverless/src/adminGetRetrievals/handler.js ***!
  \******************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/defineProperty */ \"@babel/runtime/helpers/defineProperty\");\n/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/slicedToArray */ \"@babel/runtime/helpers/slicedToArray\");\n/* harmony import */ var _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @babel/runtime/helpers/toConsumableArray */ \"@babel/runtime/helpers/toConsumableArray\");\n/* harmony import */ var _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ \"@babel/runtime/helpers/asyncToGenerator\");\n/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_3__);\n/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @babel/runtime/regenerator */ \"@babel/runtime/regenerator\");\n/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_4__);\n/* harmony import */ var _util_database_getDbConnection__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../util/database/getDbConnection */ \"./serverless/src/util/database/getDbConnection.js\");\n/* harmony import */ var _util_obfuscation_obfuscateId__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../util/obfuscation/obfuscateId */ \"./serverless/src/util/obfuscation/obfuscateId.js\");\n/* harmony import */ var _sharedUtils_config__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../sharedUtils/config */ \"./sharedUtils/config.js\");\n/* harmony import */ var _sharedUtils_parseError__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../sharedUtils/parseError */ \"./sharedUtils/parseError.js\");\n/* module decorator */ module = __webpack_require__.hmd(module);\n\n\n\n\n\n(function () {\n  var enterModule = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.enterModule : undefined;\n  enterModule && enterModule(module);\n})();\n\n\n\nfunction ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }\n\nfunction _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys(Object(source), true).forEach(function (key) { _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }\n\nvar __signature__ = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.default.signature : function (a) {\n  return a;\n};\n\n\n\n\n\nvar sortKeyMap = {\n  '-created_at': ['retrievals.created_at', 'desc'],\n  '+created_at': ['retrievals.created_at', 'asc'],\n  '-username': ['users.urs_id', 'desc'],\n  '+username': ['users.urs_id', 'asc']\n};\n/**\n * Retrieve all the retrievals for the authenticated user\n * @param {Object} event Details about the HTTP request that it received\n * @param {Object} context Methods and properties that provide information about the invocation, function, and execution environment\n */\n\nvar adminGetRetrievals = /*#__PURE__*/function () {\n  var _ref = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_3___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_4___default().mark(function _callee(event, context) {\n    var _getApplicationConfig, defaultResponseHeaders, _dbConnection$select$, _event$queryStringPar, queryStringParameters, _ref2, _ref2$page_num, pageNum, _ref2$page_size, pageSize, _ref2$sort_key, sortKey, dbConnection, retrievalResponse, _retrievalResponse, firstResponseRow, total, pagination, results;\n\n    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_4___default().wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            // https://stackoverflow.com/questions/49347210/why-aws-lambda-keeps-timing-out-when-using-knex-js\n            // eslint-disable-next-line no-param-reassign\n            context.callbackWaitsForEmptyEventLoop = false;\n            _getApplicationConfig = (0,_sharedUtils_config__WEBPACK_IMPORTED_MODULE_7__.getApplicationConfig)(), defaultResponseHeaders = _getApplicationConfig.defaultResponseHeaders;\n            _context.prev = 2;\n            _event$queryStringPar = event.queryStringParameters, queryStringParameters = _event$queryStringPar === void 0 ? {} : _event$queryStringPar;\n            _ref2 = queryStringParameters || {}, _ref2$page_num = _ref2.page_num, pageNum = _ref2$page_num === void 0 ? 1 : _ref2$page_num, _ref2$page_size = _ref2.page_size, pageSize = _ref2$page_size === void 0 ? 20 : _ref2$page_size, _ref2$sort_key = _ref2.sort_key, sortKey = _ref2$sort_key === void 0 ? '-created_at' : _ref2$sort_key; // Retrieve a connection to the database\n\n            _context.next = 7;\n            return (0,_util_database_getDbConnection__WEBPACK_IMPORTED_MODULE_5__.getDbConnection)();\n\n          case 7:\n            dbConnection = _context.sent;\n            _context.next = 10;\n            return (_dbConnection$select$ = dbConnection('retrievals').select('retrievals.id', 'retrievals.jsondata', 'retrievals.environment', 'retrievals.created_at', 'users.id as user_id', 'users.urs_id as username').select(dbConnection.raw('count(*) OVER() as total')).join('users', {\n              'retrievals.user_id': 'users.id'\n            })).orderBy.apply(_dbConnection$select$, _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_2___default()(sortKeyMap[sortKey])).limit(pageSize).offset((pageNum - 1) * pageSize);\n\n          case 10:\n            retrievalResponse = _context.sent;\n            _retrievalResponse = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1___default()(retrievalResponse, 1), firstResponseRow = _retrievalResponse[0];\n            total = firstResponseRow.total;\n            pagination = {\n              page_num: parseInt(pageNum, 10),\n              page_size: parseInt(pageSize, 10),\n              page_count: Math.ceil(total / pageSize),\n              total_results: parseInt(total, 10)\n            };\n            results = retrievalResponse.map(function (retrieval) {\n              return _objectSpread(_objectSpread({}, retrieval), {}, {\n                obfuscated_id: (0,_util_obfuscation_obfuscateId__WEBPACK_IMPORTED_MODULE_6__.obfuscateId)(retrieval.id)\n              });\n            });\n            return _context.abrupt(\"return\", {\n              isBase64Encoded: false,\n              statusCode: 200,\n              headers: defaultResponseHeaders,\n              body: JSON.stringify({\n                pagination: pagination,\n                results: results\n              })\n            });\n\n          case 18:\n            _context.prev = 18;\n            _context.t0 = _context[\"catch\"](2);\n            return _context.abrupt(\"return\", _objectSpread({\n              isBase64Encoded: false,\n              headers: defaultResponseHeaders\n            }, (0,_sharedUtils_parseError__WEBPACK_IMPORTED_MODULE_8__.parseError)(_context.t0)));\n\n          case 21:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee, null, [[2, 18]]);\n  }));\n\n  return function adminGetRetrievals(_x, _x2) {\n    return _ref.apply(this, arguments);\n  };\n}();\n\nvar _default = adminGetRetrievals;\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_default);\n;\n\n(function () {\n  var reactHotLoader = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.default : undefined;\n\n  if (!reactHotLoader) {\n    return;\n  }\n\n  reactHotLoader.register(sortKeyMap, \"sortKeyMap\", \"/Users/rabbott3/Projects/earthdata-search/serverless/src/adminGetRetrievals/handler.js\");\n  reactHotLoader.register(adminGetRetrievals, \"adminGetRetrievals\", \"/Users/rabbott3/Projects/earthdata-search/serverless/src/adminGetRetrievals/handler.js\");\n  reactHotLoader.register(_default, \"default\", \"/Users/rabbott3/Projects/earthdata-search/serverless/src/adminGetRetrievals/handler.js\");\n})();\n\n;\n\n(function () {\n  var leaveModule = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.leaveModule : undefined;\n  leaveModule && leaveModule(module);\n})();\n\n//# sourceURL=webpack://earthdata-search/./serverless/src/adminGetRetrievals/handler.js?");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./serverless/src/adminGetRetrievals/handler.js");

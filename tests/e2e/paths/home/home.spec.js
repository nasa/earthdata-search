    ...
    test.beforeEach(async ({ page }) => {
      await interceptUnauthenticatedCollections({
        ...
        additionalRequests: [{
          ...
          paramCheck: async (request) => matchesFormData(request, {
            ...
            'bounding_box[]': '-29.95172,11.43036,-16.57503,19.31775',
            keyword: 'MOD02QKM*',
            'options[temporal][limit_to_granules]': 'true',
            temporal: '2025-03-12T00:00:00.000Z,2025-03-12T23:59:59.999Z'
          })
        }],
      ...
      await page.route(/search\/granules.json/, async (route) => {
        const granulesFormData = {
          'bounding_box[]': '-29.95172,11.43036,-16.57503,19.31775',
          echo_collection_id: 'C1378579425-LAADS',
          page_num: '1',
          page_size: '20',
          sort_key: '-start_date',
          temporal: '2025-03-12T00:00:00.000Z,2025-03-12T23:59:59.999Z'
    ...
    test.beforeEach(async ({ page }) => {
      await interceptUnauthenticatedCollections({
        ...
        additionalRequests: [{
          ...
          paramCheck: async (request) => matchesFormData(request, {
            ...defaultCollectionFormData,
            'science_keywords_h[0][topic]': 'Atmosphere'
          })
        }],
        includeDefault: false
      })

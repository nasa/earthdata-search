  ...
  test.describe('When the path is loaded with a spatial query', () => {
    test.describe('When the spatial query is a point', () => {
      test('loads with the spatial query applied', async ({ page }) => {
        ...
        await expect(page.locator('.leaflet-marker-pane img')).toHaveAttribute('style', 'margin-left: -12px; margin-top: -41px; width: 25px; height: 41px; transform: translate3d(1165px, 402px, 0px); z-index: 402;')
      })
    })
    ...
    test.describe('When the spatial query is a polygon', () => {
      test('loads with the spatial query applied', async ({ page }) => {
        ...
        // Test leaflet has drawn the shape correctly
        await expect(page.locator('.leaflet-interactive')).toHaveAttribute('d', 'M1161 423L1122 499L1257 518L1161 423z')
      })
    })
    ...
    test.describe('When the spatial query is a circle', () => {
      test('loads with the spatial query applied', async ({ page }) => {
        ...
        // Test leaflet has drawn the shape correctly
        await expect(page.locator('.leaflet-interactive')).toHaveAttribute('d', 'M1136.1837511111112,417.20238222222224a6,6 0 1,0 12,0 a6,6 0 1,0 -12,0 ')
      })
    })
    ...
    test.describe('When the spatial query is a bounding box', () => {
      test('loads with the spatial query applied', async ({ page }) => {
        ...
        // Test leaflet has drawn the shape correctly
        await expect(page.locator('.leaflet-interactive')).toHaveAttribute('d', 'M736 426L736 247L934 247L934 426L736 426z')
      })
    })
    ...
    test.describe('When the spatial query is a shapefile', () => {
      test('loads with the spatial query applied', async ({ page }) => {
        ...
        // Test leaflet has drawn the shape correctly
        await expect(page.locator('.leaflet-interactive').first()).toHaveAttribute('d', 'M1161 423L1122 499L1257 518L1161 423z')
      })
    })
  })

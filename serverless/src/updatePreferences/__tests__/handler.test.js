...
beforeEach(() => {
  ...
  jest.spyOn(getJwtToken, 'getJwtToken')
    .mockImplementation(() => 'mockJwt');

  jest.spyOn(getVerifiedJwtToken, 'getVerifiedJwtToken')
    .mockImplementation(() => ({
      id: 1,
      username: 'testuser'
    }));

  jest.spyOn(getDbConnection, 'getDbConnection')
...
describe('updatePreferences', () => {
  ...
  test('correctly returns an error on query failure', async () => {

    ...
    let(:expected_body) do
      {
        'collection' => {
          ...
          "osdd_url" => "https://api.echo.nasa.gov/opensearch/granules/descriptor_document.xml?utf8=%E2%9C%93&clientId=#{Rails.configuration.opensearch_client_id}&shortName=AST_L1AE&versionId=3&dataCenter=LPDAAC&commit=Generate",
          "xml" => {
            "ShortName"=>"AST_L1AE",
            "VersionId"=>"3",
            "LongName"=>"ASTER Expedited L1A Reconstructed Unprocessed Instrument Data",

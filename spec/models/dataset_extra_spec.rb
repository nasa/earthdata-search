...
describe DatasetExtra do
  context "result decoration" do
    ...
    it "adds additional attribute definitions" do
      ...
      extra = DatasetExtra.new(searchable_attributes: attrs)
      result = extra.decorate(dataset_hash)
    ...
    it "adds orbit information" do
      dataset_hash = {}
      extra = DatasetExtra.new(orbit: {'orbit_param' => 'value'})
      result = extra.decorate(dataset_hash)
  ...
  context "#clean_attributes" do
    def clean_attributes(*options)
      ...
      DatasetExtra.new(searchable_attributes: {'attributes' => persisted}).clean_attributes.first
    end

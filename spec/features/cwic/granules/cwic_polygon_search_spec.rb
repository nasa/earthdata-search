...
describe 'CWIC-enabled polygon searches' do
  ...
  context 'when a polygon search condition has been applied' do
    before :all do
      ...
      load_page :search, q: 'USGS_EDC_EO1_ALI', ac: true, polygon: [[10, 10], [10, -10], [-10, -10], [-10, 10], [10, 10]]
      wait_for_xhr
    end
  ...
  context 'viewing non-CWIC granule results' do
    before :all do
      Capybara.reset_sessions!
      load_page :search, q: 'C14758250-LPDAAC_ECS', polygon: [[10, 10], [10, -10], [-10, -10], [-10, 10], [10, 10]]
      wait_for_xhr
    end

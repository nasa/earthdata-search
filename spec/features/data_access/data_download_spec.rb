...
describe 'Data download page', reset: false do
  ...
  context 'when some accessed collections have additional resource or documentation links' do
    ...
    it 'displays links for collections with additional resources and documentation' do
      expect(page).to have_link('https://lpdaac.usgs.gov/')
    end
    ...
    context 'clicking on a "View Browse Image Links" button' do
      ...
      it 'displays links to browse images' do
        within_last_window do
          expect(page).to have_link('https://n5eil01u.ecs.nsidc.org/DP0/BRWS/Browse.001/2015.01.02/BROWSE.MYD29P1N.A2015001.h10v25.005.2015002203748.1.jpg')
        end
      end
    end
  end
    ...
    context 'upon clicking a "Download Access Script" button' do
      ...
      it "displays a page with a shell script on it which performs the user's query" do
        within_last_window do
          ...
          expect(page).to have_content('https://e4ftl01.cr.usgs.gov//DP106/MOLT/MOD13Q1.006/2014.06.26/MOD13Q1.A2014177.h17v04.006.2015288071335.hdf')
        end
      end
      ...
      context 'and click "Download Script File" button' do
        ...
        it 'downloads a shell script' do
          within_last_window do
            ...
            expect(page.source).to have_content('https://e4ftl01.cr.usgs.gov//DP106/MOLT/MOD13Q1.006/2014.06.26/MOD13Q1.A2014177.h17v04.006.2015288071335.hdf')
            expect(page.source).to have_content('machine urs.earthdata.nasa.gov')
          end
        end
      end
    end

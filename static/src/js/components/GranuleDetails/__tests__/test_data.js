...
let formattedGranuleString = '    GranuleUR: 1860_1993_2050_NITROGEN.N-deposition1860.tfw\n'
formattedGranuleString += '    InsertTime: 2006-04-14T00:00:00Z\n'
formattedGranuleString += '    LastUpdate: 2006-04-14T00:00:00Z\n'
formattedGranuleString += '    Collection: \n'
formattedGranuleString += '        ShortName: 1860_1993_2050_NITROGEN_830\n'
formattedGranuleString += '        VersionId: 1\n'
formattedGranuleString += '    DataGranule: \n'
formattedGranuleString += '        SizeMBDataGranule: 0.0002\n'
formattedGranuleString += '        DayNightFlag: BOTH\n'
formattedGranuleString += '        ProductionDateTime: 2006-04-14T00:00:00Z\n'
formattedGranuleString += '    Temporal: \n'
formattedGranuleString += '        RangeDateTime: \n'
formattedGranuleString += '            BeginningDateTime: 1860-01-01T00:00:00Z\n'
formattedGranuleString += '            EndingDateTime: 2050-12-31T00:00:00Z\n'
formattedGranuleString += '    Spatial: \n'
formattedGranuleString += '        HorizontalSpatialDomain: \n'
formattedGranuleString += '            Geometry: \n'
formattedGranuleString += '                BoundingRectangle: \n'
formattedGranuleString += '                    WestBoundingCoordinate: -180\n'
formattedGranuleString += '                    NorthBoundingCoordinate: 90\n'
formattedGranuleString += '                    EastBoundingCoordinate: 180\n'
formattedGranuleString += '                    SouthBoundingCoordinate: -90\n'
formattedGranuleString += '    MeasuredParameters: \n'
formattedGranuleString += '        MeasuredParameter: \n'
formattedGranuleString += '            ParameterName: NITROGEN OXIDES\n'
formattedGranuleString += '        MeasuredParameter: \n'
formattedGranuleString += '            ParameterName: NITROGEN COMPOUNDS\n'
formattedGranuleString += '    Platforms: \n'
formattedGranuleString += '        Platform: \n'
formattedGranuleString += '            ShortName: NOT APPLICABLE\n'
formattedGranuleString += '            Instruments: \n'
formattedGranuleString += '                Instrument: \n'
formattedGranuleString += '                    ShortName: NOT APPLICABLE\n'
formattedGranuleString += '    Campaigns: \n'
formattedGranuleString += '        Campaign: \n'
formattedGranuleString += '            ShortName: climate\n'
formattedGranuleString += '    Price: 0\n'
formattedGranuleString += '    OnlineAccessURLs: \n'
formattedGranuleString += '        OnlineAccessURL: \n'
formattedGranuleString += '            URL: https://daac.ornl.gov/daacdata/global_climate/global_N_deposition_maps/data/N-deposition1860.tfw\n'
formattedGranuleString += '            URLDescription: This link provides direct download access to the granule.\n'
formattedGranuleString += '    OnlineResources: \n'
formattedGranuleString += '        OnlineResource: \n'
formattedGranuleString += '            URL: https://daac.ornl.gov/CLIMATE/guides/global_N_deposition_maps.html\n'
formattedGranuleString += '            Description: ORNL DAAC Data Set Documentation\n'
formattedGranuleString += '            Type: USERS GUIDE\n'
formattedGranuleString += '        OnlineResource: \n'
formattedGranuleString += '            URL: https://dx.doi.org/doi:10.3334/ORNLDAAC/830\n'
formattedGranuleString += '            Description: Data set Landing Page DOI URL\n'
formattedGranuleString += '            Type: DATA SET LANDING PAGE\n'
formattedGranuleString += '        OnlineResource: \n'
formattedGranuleString += '            URL: https:/daac.ornl.gov/daacdata/global_climate/global_N_deposition_maps/comp/deposition_maps.jpg\n'
formattedGranuleString += '            Description: Data Set Documentation\n'
formattedGranuleString += '            Type: GENERAL DOCUMENTATION\n'
formattedGranuleString += '        OnlineResource: \n'
formattedGranuleString += '            URL: https:/daac.ornl.gov/daacdata/global_climate/global_N_deposition_maps/comp/global_N_deposition_maps.pdf\n'
formattedGranuleString += '            Description: Data Set Documentation\n'
formattedGranuleString += '            Type: GENERAL DOCUMENTATION\n'
formattedGranuleString += '        OnlineResource: \n'
formattedGranuleString += '            URL: https:/daac.ornl.gov/daacdata/global_climate/global_N_deposition_maps/comp/global_N_deposition_maps_readme.pdf\n'
formattedGranuleString += '            Description: Data Set Documentation\n'
formattedGranuleString += '            Type: GENERAL DOCUMENTATION\n'
formattedGranuleString += '    Orderable: false\n'
formattedGranuleString += '    DataFormat: ascii\n'

export const formattedGranuleInformation = formattedGranuleString

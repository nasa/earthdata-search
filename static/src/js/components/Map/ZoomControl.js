...
class ZoomControl extends Zoom {
  constructor(options) {
    ...
    homeElement.className = `${options.className}-home edsc-map__controls__button`
    ...
    zoomInElement.className = `${options.className}-in edsc-map__controls__button`
    ...
    zoomOutElement.className = `${options.className}-out edsc-map__controls__button`

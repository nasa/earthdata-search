...
/**
 * Defines the structure for Harmony service subsetting capabilities.
 */
...
/**
 * Defines the capabilities for a specific Harmony service.
 */
export type HarmonyServiceCapabilities = {
  /** Spatial, temporal, and variable subsetting options */
  subsetting: HarmonySubsetting
  /** A list of supported output mime-types, such as "application/x-hdf" */
  output_formats: string[]
}

/**
 * Details regarding a specific Harmony service and its unique capabilities.
 */
export type HarmonyService = {
  /** The name of the service (e.g., "sds/trajectory-subsetter") */
  name: string
  /** The CMR concept URL for the service */
  href: string
  /** The specific capabilities supported by this individual service */
  capabilities: HarmonyServiceCapabilities
}

/**
 * Represents the overall Harmony capabilities for a given collection.
 */
export type HarmonyCapabilities = {
  /** The CMR Concept ID of the collection */
  conceptId: string
  /** The short name of the collection */
  shortName: string
  /** True if variable subsetting is supported for the collection */
  variableSubset: boolean
  /** True if bounding box subsetting is supported for the collection */
  bboxSubset: boolean
  /** True if shapefile subsetting is supported for the collection */
  shapeSubset: boolean
  /** True if temporal subsetting is supported for the collection */
  temporalSubset: boolean
  /** True if the service can concatenate multiple input files into a single output */
  concatenate: boolean
  /** True if the service can reproject data to a different Coordinate Reference System (CRS) */
  reproject: boolean
  /** A list of supported output mime-types for the collection */
  outputFormats: string[]
  /** A list of Harmony services available for this collection */
  services: HarmonyService[]
  /** A list of variables associated with the collection */
  variables: unknown[]
  /** The version of the capabilities document schema */

...
export const humanizedQueryValueFormattingMap = {
  boundingBox: (value) => formatPoints([].concat(value)),
  browseOnly: (value) => formatBoolean(value),
  circle: (value) => formatCircle([].concat(value)),
  ...
  line: (value) => formatPoints([].concat(value)),
  onlineOnly: (value) => formatBoolean(value),
  platformsH: (value) => formatFacetHierarchy(value, platformsHierarchy),
  point: (value) => formatPoints([].concat(value)),
  polygon: (value) => formatPoints([].concat(value)),

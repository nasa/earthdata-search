...
describe('project#convertSize', () => {
  ...
  test('returns GB correctly', () => {
    expect(convertSize(43008)).toEqual({
      size: '42.0',
      unit: 'GB'
    })
  })
  ...
  test('returns TB correctly', () => {
    expect(convertSize(44040192)).toEqual({
      size: '42.0',
      unit: 'TB'
    })
  })
  ...
  test('returns PB correctly', () => {
    expect(convertSize(45097156608)).toEqual({
      size: '42.0',
      unit: 'PB'
    })
  })
  ...
  test('returns EB correctly', () => {
    expect(convertSize(46179488366592)).toEqual({
      size: '42.0',
      unit: 'EB'
    })
  })

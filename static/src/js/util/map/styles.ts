...
export const granuleStyle = (index: number) => new Style({
  stroke: new Stroke({
...
export const deemphisizedGranuleStyle = (index: number) => new Style({
  stroke: new Stroke({
...
export const granulePointStyle = (index: number) => new Style({
  image: new CircleStyle({
    radius: pointRadius,
    stroke: new Stroke({
      color: getColorByIndex(index),
...
export const deemphisizedGranulePointStyle = (index: number) => new Style({
  image: new CircleStyle({
    radius: pointRadius,
    stroke: new Stroke({
      color: getColorByIndex(index, true),
...
export const highlightedGranuleStyle = (index: number) => new Style({
  stroke: new Stroke({
    color: getColorByIndex(index),
    width: 4
  }),
...
export const highlightedGranulePointStyle = (index: number) => new Style({
  image: new CircleStyle({
    radius: pointRadius,
    stroke: new Stroke({
      color: getColorByIndex(index),

...
export const drawGranuleOutlines = ({
  ...
  console.log('🚀 ~ drawing.js:108 ~ projectionCode:', projectionCode)
  // TODO this gets called every pixel the map is moved, we should probably find a way to optimize this

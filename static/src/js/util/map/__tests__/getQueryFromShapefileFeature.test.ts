...
describe('getQueryFromShapefileFeature', () => {
  ...
  test('removes altitude from deeply nested MultiPolygon structure', () => {
    ...
    expect(result).toEqual({
      polygon: [
        '-77.0163,38.883,100,-77.0164,38.884,101,-77.0165,38.885,102,-77.0163,38.883,100',
        '-76.0163,37.883,200,-76.0164,37.884,201,-76.0165,37.885,202,-76.0163,37.883,200'
      ]
    })
  })
})

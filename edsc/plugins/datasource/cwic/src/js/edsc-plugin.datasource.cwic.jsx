  ...
  downloadLinks() {
    ...
    if (this.data()) {
      ...
      if (url) {
        ...
        result.push({title: "Download Data Links File", url: urlUtil.fullPath(downloadUrl + "&download_format=text"), tooltip: 'Download executable shell script (requires UNIX environment)'});
      }
    }

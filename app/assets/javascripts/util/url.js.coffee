...
this.edsc.util.url = do(window
  ...
  compressors = [
    ...
    new ParamFlattener(['science_keywords', '0', 'category'], 'fsc', false)
    new ParamFlattener(['science_keywords', '1', 'topic'], 'fst', false)
    new ParamFlattener(['science_keywords', '2', 'term'], 'fsm', false)
    new ParamFlattener(['science_keywords', '3', 'variable_level_1'], 'fs1', false)
    new ParamFlattener(['science_keywords', '4', 'variable_level_2'], 'fs2', false)
    new ParamFlattener(['science_keywords', '5', 'variable_level_3'], 'fs3', false)
    new ParamFlattener(['science_keywords', '6', 'detailed_variable'], 'fsd', false)

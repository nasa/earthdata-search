...
this.edsc.util.url = do(window
  ...
  compressors = [
    ...
    new ParamFlattener(['science_keywords_h', '2', 'term'], 'fsm', false)
    new ParamFlattener(['science_keywords_h', '3', 'variable_level_1'], 'fs1', false)
    new ParamFlattener(['science_keywords_h', '4', 'variable_level_2'], 'fs2', false)
    new ParamFlattener(['science_keywords_h', '5', 'variable_level_3'], 'fs3', false)
    new ParamFlattener(['science_keywords_h', '6', 'detailed_variable'], 'fsd', false)

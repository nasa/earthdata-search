...
#    new ParamFlattener(['science_keywords', '1', 'category'], 'fsc', false)
#    new ParamFlattener(['science_keywords', '1', 'topic'], 'fst', false)
#    new ParamFlattener(['science_keywords', '1', 'term'], 'fsm', false)
#    new ParamFlattener(['science_keywords', '1', 'variable_level_1'], 'fs1', false)
#    new ParamFlattener(['science_keywords', '1', 'variable_level_2'], 'fs2', false)
#    new ParamFlattener(['science_keywords', '1', 'variable_level_3'], 'fs3', false)
#    new ParamFlattener(['science_keywords', '1', 'detailed_variable'], 'fsd', false)

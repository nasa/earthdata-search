...
#   # class GranuleCanvasLayer extends L.TileLayer
#   GranuleCanvasLayer = L.GridLayer.extend
#     options:
#       async: true
#
#     initialize: (url, options, @multiOptions) ->
#       layer = L.TileLayer.prototype.initialize.call(this, url, options)
...
#       # tile.width = tile.height = @getTileSize()
#       size = @getTileSize()
#       tile.width = size.x
#       tile.height = size.y
...
#   class GranuleLayer extends GranuleCanvasLayer
#   # class GranuleLayer extends L.TileLayer
...
#       @color = color ? '#25c85b';
#       super(@url(), L.extend({}, color: @color), @multiOptions)
#       # super({})
#
#     onAdd: (map) ->
#       # super(map)
...
#       layer = new L.tileLayer(url, L.extend(@_toTileLayerOptions(newOptions), color: @color), @multiOptions)
#
